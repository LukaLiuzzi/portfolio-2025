...
const Footer = () => {
  return (
    <div
      className="text-center font-bold text-muted-foreground py-4 flex flex-col-reverse sm:flex-row gap-4 justify-between items-center border-t border-border mt-4 rounded-md p-8"
      style={{
